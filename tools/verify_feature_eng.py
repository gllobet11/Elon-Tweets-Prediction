...
def verify_feature_engineering():
    ...
    try:
        ...
        market_start_date_aware = pd.Timestamp("2025-11-25 17:00:00").tz_localize('America/New_York').tz_convert('UTC')
        ...
        print(f"  -> Fecha de mercado (naive) para comparación: {market_start_date_naive}")
