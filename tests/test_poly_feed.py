...
@pytest.mark.parametrize(
    "description, expected_start, expected_end",
    [
        (
            "from December 2, 2025 12:00 PM ET to December 9, 2025 12:00 PM ET",
            "2025-12-02 17:00:00",
            "2025-12-09 17:00:00",
        ),
        (
            "from December 30, 2024 12:00 PM ET to January 6, 2025 12:00 PM ET",
            "2024-12-30 17:00:00",
            "2025-01-06 17:00:00",
        ),
        (
            "from December 23 12:00 PM ET to December 30, 2024 12:00 PM ET",
            "2024-12-23 17:00:00",
            "2024-12-30 17:00:00",
        ),
    ],
...
def test_fetch_market_ids_automatically(poly_feed, mock_clob_client):
    ...
    mock_markets_response["data"][1]["question"] = (
        "300-319: How many tweets will Elon Musk post from Nov 25 to December 2?"
    )
