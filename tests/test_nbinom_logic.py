...
def run_stability_test():
    ...
    print(
        "A higher alpha means 'fatter tails' (higher probability of extreme events).\n",
    )
    ...
    for scenario in scenarios:
        ...
        try:
            ...
            comparison_df["Diff (NB - P)"] = (
                comparison_df["NBinom"] - comparison_df["Poisson"]
            )
            ...
            print(
                f"Peak Probability (Poisson): {peak_poisson['Poisson']:.2%} in bin '{peak_poisson['Bin']}'",
            )
            print(
                f"Peak Probability (NBinom):  {peak_nbinom['NBinom']:.2%} in bin '{peak_nbinom['Bin']}'",
            )
            ...
            print(
                f"Sum of Probabilities (NBinom):  {comparison_df['NBinom'].sum():.4f}\n",
            )
